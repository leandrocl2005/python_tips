...
def compute_horas_obrigatorias(algebra_linear, geometria_analitica, fundamentos):
...
def compute_horas_eletivas(disciplinas_eletivas):
...
def compute_cr(algebra_linear, geometria_analitica, fundamentos, disciplinas_eletivas):
    cr = 0
    if algebra_linear["aprovado"]:
...
def validate_obrigatorias(algebra_linear, geometria_analitica, fundamentos):
...
def validate_eletivas(
    algebra_linear, geometria_analitica, fundamentos, disciplinas_eletivas
):
...
def validate_complementares(
    algebra_linear, geometria_analitica, fundamentos, complementares
):
    horas_obrigatorias = compute_horas_obrigatorias(
        algebra_linear, geometria_analitica, fundamentos
    )
...
def validate_ensino_medio(completou_ensino_medio):
...
def gerar_certificado_com_cr_e_ch(aluno):
    ...
    validate_obrigatorias(algebra_linear, geometria_analitica, fundamentos)
    ...
    validate_complementares(
        algebra_linear, geometria_analitica, fundamentos, complementares
    )

    # aluno deve ter concluído o médio
    validate_ensino_medio(completou_ensino_medio)

    cr = compute_cr(
        algebra_linear, geometria_analitica, fundamentos, disciplinas_eletivas
    )
    ch_eletivas = compute_horas_eletivas(disciplinas_eletivas)
    ch_obrigatorias = compute_horas_obrigatorias(
        algebra_linear, geometria_analitica, fundamentos
    )
    ch_total = ch_eletivas + ch_obrigatorias

    return f"{name} completou a graduação com CH de {ch_total} e CR de {cr}"
